...
class PetHospitalAddScreen extends StatefulWidget {
  const PetHospitalAddScreen({super.key});

  @override
  State<PetHospitalAddScreen> createState() => _PetHospitalAddScreenState();
}

class _PetHospitalAddScreenState extends State<PetHospitalAddScreen> {
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  labelText:
                      "Please Enter Hospital Name  *", // Use labelText instead of label
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  labelText:
                      "Please Enter Name  *", // Use labelText instead of label
                  labelStyle: TextStyle(
                    fontSize: 15,
                    fontWeight: FontWeight.w500,
                    color: Color(0xff034B56),
              ...
              child: CustomButton(
                ...
                onPressed: () async {
                  try {
                    ...
                    PetConsultationModel pet = PetConsultationModel(
                      images: imagePaths,
                      mail: email.text.trim(),
                      hName: hname.text.trim(),
                      dName: dname.text.trim(),
                      location: area.text.trim(),
                      category: selectedValue!,
                      fee: fee.text.trim(),
                      hours: hour.text.trim(),
